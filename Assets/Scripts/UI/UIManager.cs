...
/// <summary>
/// Manager class that holds references to all UI layers and handles the UI
/// stack.
/// </summary>
public class UIManager : MonoBehaviour {
  ...
  void Start() {
    ...
    _towerMenuSystem =
        transform.Find("TowerMenuUI").GetComponent<TowerMenuUISystem>();
    _upgradeMenuSystem =
        transform.Find("UpgradeUI").GetComponent<UpgradeMenuUISystem>();
  ...
  public void HideAll() {
    // TODO: This should receive an event instead.
    foreach(IUISystem ui in _screenStack) { ui.Destroy(); }
